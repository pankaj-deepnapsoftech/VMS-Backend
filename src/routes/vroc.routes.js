...
import { AssertInventory, AttackExposure, FinancialExposure, FinancialExposureTrand, GetRiskScoreData, RemediationWorkflow, RiskTrend, TopFiveRiskIndicator } from "../controller/VROC.controller.js";
...
routes.route("/attack-exposure").get(AttackExposure);

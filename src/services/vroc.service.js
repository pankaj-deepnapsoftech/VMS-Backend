...
export const VrocAggraction = async (matchfilter) => {
        ...
        pipeline: [
              ...
              pipeline: [
                ...
                },
                {
                  $addFields: {
                    ...
                    tag_name: { $arrayElemAt: ["$data_sensitivity.tag_name", 0] },
          ...
          },
          {
            $addFields: {
              ...
              tag_name: { $arrayElemAt: ["$asset.tag_name", 0] },
...
export const FinancialExposureService = async (matchfilter) => {
  const data = await DataModel.aggregate([
    {
      $match: matchfilter
    },
